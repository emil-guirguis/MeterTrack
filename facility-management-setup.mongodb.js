// MongoDB Setup Script for Facility Management System
// Connection: mongodb+srv://emil_user:db2424@cluster0.tveleqd.mongodb.net/

// Use the facility management database
...
db.buildings.insertMany([
  {
    ...
    equipmentCount: 0, // Will be calculated
    meterCount: 0, // Will be calculated
    createdAt: new Date(),
    updatedAt: new Date()
  },
  {
...
db.equipment.insertMany([
  ...
  },
  {
    ...
    serialNumber: 'CONV-003-2023',
    manufacturer: 'FlexLink',
    model: 'FL-2000',
    location: 'Main Floor - Loading Area',
    notes: 'Lubrication required monthly',
    createdAt: new Date(),
    updatedAt: new Date()
  }
]);
...
// Create email templates collection with sample data
db.emailTemplates.insertMany([
  {
    ...
    variables: [
      ...
      { name: 'maintenanceType', description: 'Type of maintenance', type: 'text', required: false }
    ],
  ...
  },
  {
    ...
    content: `
      ...
      <p>Dear {{tenantName}},</p>
      <p>Welcome to your new space at {{buildingName}}. We're excited to have you as part of our community.</p>
      <h3>Important Information:</h3>
      <ul>
        <li><strong>Move-in Date:</strong> {{moveInDate}}</li>
        <li><strong>Unit/Floor:</strong> {{unitNumber}}</li>
        <li><strong>Building Manager:</strong> {{managerName}}</li>
        <li><strong>Emergency Contact:</strong> {{emergencyPhone}}</li>
      </ul>
      <p>If you have any questions, please don't hesitate to contact us.</p>
      <p>Welcome aboard!<br>{{managerName}}<br>Building Management</p>
    `,
    variables: [
      { name: 'tenantName', description: 'Tenant name', type: 'text', required: true },
      { name: 'buildingName', description: 'Building name', type: 'text', required: true },
      { name: 'moveInDate', description: 'Move-in date', type: 'date', required: true },
      { name: 'unitNumber', description: 'Unit or floor number', type: 'text', required: true },
      { name: 'managerName', description: 'Building manager name', type: 'text', required: true },
      { name: 'emergencyPhone', description: 'Emergency contact phone', type: 'text', required: true }
    ],
...
// ============================================================================
// 8. UPDATE BUILDING EQUIPMENT/METER COUNTS
// ============================================================================
