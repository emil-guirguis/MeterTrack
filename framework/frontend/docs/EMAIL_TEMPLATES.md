...
See `MIGRATION_GUIDE.md` in the email-templates directory for detailed instructions on migrating existing email template code to use this framework.
...
This framework satisfies requirements 15.1-15.7 from the framework migration specification.
