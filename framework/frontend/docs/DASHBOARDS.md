...
See `MIGRATION_GUIDE.md` in the dashboards directory for detailed instructions on migrating existing dashboards to use the framework.
...
This framework satisfies requirements 13.1-13.6 from the framework migration specification.
