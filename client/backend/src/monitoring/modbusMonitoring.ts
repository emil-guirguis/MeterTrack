...
export class ModbusMonitoring extends EventEmitter {
   ...
   */
  public recordOperation(success: boolean, responseTime: number, error?: Error): void {
   ...
   * Check connection pool health
   */
  private checkConnectionPoolHealth(issues: string[]): boolean {
   ...
   * Check memory health
   */
  private checkMemoryHealth(issues: string[]): boolean {
   ...
   */
  private checkResponseTimeHealth(issues: string[]): boolean {
   ...
   */
  private checkErrorRateHealth(issues: string[]): boolean {
