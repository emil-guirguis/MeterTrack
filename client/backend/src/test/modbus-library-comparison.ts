...
import { ModbusConnectionConfig, ModbusResult, RegisterReadResponse } from '../types/modbus';
...
export class ModbusLibraryComparison {
   ...
   */
  async testModbusSerial(): Promise<ComparisonResult> {
   ...
   */
  async testJsModbus(): Promise<ComparisonResult> {
    const startTime = Date.now();
...
if (require.main === module) {
  const testConfig: ModbusConnectionConfig = {
