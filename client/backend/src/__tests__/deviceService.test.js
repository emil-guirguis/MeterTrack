...
describe('DeviceService', () => {
  ...
  describe('updateDevice', () => {
    it('should update device with valid data', async () => {
      ...
      expect(db.query).toHaveBeenCalledWith(
        'UPDATE devices SET name = $1, description = $2, updatedat = CURRENT_TIMESTAMP WHERE id = $3 RETURNING *',
        ['Updated Device', 'Updated Description', '123e4567-e89b-12d3-a456-426614174000']
      );
      expect(result).toEqual({
        id: '123e4567-e89b-12d3-a456-426614174000',
        name: 'Updated Device',
    ...
    it('should update only name when description not provided', async () => {
      ...
      expect(db.query).toHaveBeenCalledWith(
        'UPDATE devices SET name = $1, updatedat = CURRENT_TIMESTAMP WHERE id = $2 RETURNING *',
        ['Updated Device', '123e4567-e89b-12d3-a456-426614174000']
      );
    });
    ...
    it('should update only description when name not provided', async () => {
      ...
      expect(db.query).toHaveBeenCalledWith(
        'UPDATE devices SET description = $1, updatedat = CURRENT_TIMESTAMP WHERE id = $2 RETURNING *',
        ['Updated Description', '123e4567-e89b-12d3-a456-426614174000']
      );
    });
