...
class SettingsService {
    ...
    static formatForDatabase(frontendData) {
        ...
        if (frontendData.name)
            dbData.company_name = frontendData.name;
        // logo field not yet implemented in DB schema
        if (frontendData.address) {
            if (frontendData.address.street)
                dbData.company_address_street = frontendData.address.street;
            if (frontendData.address.city)
                dbData.company_address_city = frontendData.address.city;
            if (frontendData.address.state)
                dbData.company_address_state = frontendData.address.state;
            if (frontendData.address.zipCode)
                dbData.company_address_zip_code = frontendData.address.zipCode;
            if (frontendData.address.country)
                dbData.company_address_country = frontendData.address.country;
        }
        if (frontendData.contact) {
            if (frontendData.contact.phone)
                dbData.company_phone = frontendData.contact.phone;
            if (frontendData.contact.email)
                dbData.company_email = frontendData.contact.email;
            if (frontendData.contact.website)
                dbData.company_website = frontendData.contact.website;
        }
        if (frontendData.systemConfig) {
            if (frontendData.systemConfig.timezone)
                dbData.default_timezone = frontendData.systemConfig.timezone;
            if (frontendData.systemConfig.currency)
                dbData.default_currency = frontendData.systemConfig.currency;
