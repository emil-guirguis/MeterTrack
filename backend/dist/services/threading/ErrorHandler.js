...
(function (ErrorType) {
    ErrorType["WORKER_STARTUP"] = "worker_startup";
    ErrorType["WORKER_RUNTIME"] = "worker_runtime";
...
(function (RecoveryStrategy) {
    ...
    RecoveryStrategy["RESTART_WORKER"] = "restart_worker";
...
export class ErrorHandler extends EventEmitter {
    ...
    getErrorStats() {
        ...
        Object.entries(errorsByType).forEach(([type, count]) => {
            if (!mostCommonError || count > mostCommonError.count) {
                mostCommonError = { type: type, count };
            }
        });
        return {
     ...
     */
    async activateCircuitBreaker(errorInfo) {
