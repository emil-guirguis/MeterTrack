...
describe('ModbusMCPServerWorker', () => {
    ...
    describe('constructor', () => {
        test('should initialize with provided configuration', () => {
            ...
            expect(mockLogger.info).toHaveBeenCalledWith('ModbusMCPServerWorker initialized', expect.objectContaining({
    ...
    describe('start', () => {
        ...
        test('should handle start errors', async () => {
            ...
            expect(mockLogger.error).toHaveBeenCalledWith('Failed to start MCP Server in worker thread:', expect.any(Error));
        });
    });
    describe('shutdown', () => {
        ...
        test('should handle shutdown errors', async () => {
            ...
            expect(mockLogger.error).toHaveBeenCalledWith('Error during MCP Server shutdown:', expect.any(Error));
        });
    });
    describe('getStatus', () => {
...
//# sourceMappingURL=ModbusMCPServerWorker.test.js.map