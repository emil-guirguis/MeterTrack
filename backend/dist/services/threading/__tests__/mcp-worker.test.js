...
describe('MCP Worker Thread', () => {
    ...
    describe('message handling', () => {
        ...
        test('should handle start message', async () => {
            ...
            expect(mockMessagePort.postMessage).toHaveBeenCalledWith(expect.stringContaining('"type":"success"'));
        });
        ...
        test('should handle status message', async () => {
            ...
            expect(mockMessagePort.postMessage).toHaveBeenCalledWith(expect.stringContaining('"type":"status"'));
        });
        ...
        test('should handle data message', async () => {
            ...
            expect(mockMessagePort.postMessage).toHaveBeenCalledWith(expect.stringContaining('"type":"data"'));
        });
        test('should handle ping message', async () => {
            ...
            expect(mockMessagePort.postMessage).toHaveBeenCalledWith(expect.stringContaining('"type":"pong"'));
        });
        test('should handle unknown message type', async () => {
            ...
            expect(mockMessagePort.postMessage).toHaveBeenCalledWith(expect.stringContaining('"type":"error"'));
        });
    });
...
//# sourceMappingURL=mcp-worker.test.js.map